...
import 'package:arknights_wiki/firebase_options.dart';
import 'package:arknights_wiki/router.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => OperatorBloc(OperatorServices())),
        BlocProvider(create: (context) => OperatorImagesBloc(OperatorImagesServices()))
      ],
